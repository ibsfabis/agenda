...
if (!empty($erros))
{
    echo "
        ...
        <html>
            <head>
                 <!-- <META http-equiv=\"refresh\" content=\"0;URL=http://localhost/agenda/pages/register.php\"> -->
            </head>
            <body onload=\"alerta();\">
            </body>
        </html>
...
<html>
    <head>
        <META http-equiv="refresh" content="1;URL=http://localhost/agenda/pages/login.php">
    </head>
</html>