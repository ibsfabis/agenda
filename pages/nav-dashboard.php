...
<nav class="navbar navbar-default">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="http://localhost/agenda">
            ...
            <ul class="nav navbar-nav">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="#">Cidades</a>
                            <ul>
                                <li><a href="cad-cidade.php">Incluir</li>
                                <li><a href="lista-cidade.php">Listagem</li>
                            </ul>
                        </li>
                        ...
                        <li><a href="cad-contato.php">Contatos</a>
                            <ul>
                                <li><a href="cad-contato.php">Incluir</li>
                                <li><a href="lista-contato.php">Listagem</li>
                            </ul>
